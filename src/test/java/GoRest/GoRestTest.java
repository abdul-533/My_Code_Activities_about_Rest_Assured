...
public class GoRestTest {
    ...
    public void setup() {
        ...
        reqSpec = new RequestSpecBuilder()
                .addHeader("Authorization", "Bearer 8d2a4b55a32d0c02611440edee27902a6767b0c4695c612b5bc67e58375b64ca")
    ...
    public void createUserMap() {
        ...
        userID =
                given()
                        .header("Authorization", "Bearer 8d2a4b55a32d0c02611440edee27902a6767b0c4695c612b5bc67e58375b64ca")
                        .contentType(ContentType.JSON)
                        .body(newUser)
                        .log().uri()
                        //.log().body()
...
/*
HaftaSonu TODO:  GoRest de daha önce yaptığınız posts ve comments resourcelarını
            API Automation yapınız(Create,get,update,delete,deletenegatife)
 */
}
